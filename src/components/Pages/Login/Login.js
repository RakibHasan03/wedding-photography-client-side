...
const Login = () => {
    ...
    return (
        <div>
            <marquee behavior="" direction="" className=' py-3 text-gray-500'>
                Admin Email: <u>admin@gmail.com</u>  & password: <u>rakib01767</u>
            </marquee>
            <div className=" grid md:grid-cols-2  w-11/12 mx-auto gap-7 mt-6 mb-12">
                    ...
                    <div className='flex justify-center '>
                        ...
                        <div className="w-full max-w-md p-4 rounded-md  sm:p-8  dark:text-gray-100 shadow-2xl bg-sky-600">
                            ...
                            <div className="my-6 space-y-4">
                                <button onClick={googleHandler} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-violet-800 text-white sign-button shadow-2xl font-semibold">
